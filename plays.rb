...
class Play
  ...
  # returns an array of Play class instances
  def self.all
...
if $PROGRAM_NAME == __FILE__
  # p Playwright.all  #no william shakespeare
  # writer = Playwright.new("name" => "William Shakespeare", "birth_year" => 1564)
  # writer.create
  # p Playwright.all #now there is william shakespeare
  #
end
